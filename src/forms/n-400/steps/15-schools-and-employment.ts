...
/** Real page is a repeating "Add entry" list — see i-130/08-your-address-history.ts for the same pattern. */
export const schoolsAndEmploymentStep: StepSchema = {
  id: 'schools-and-employment',
  section: 'About You',
  title: 'Schools and Employment',
  description: 'Where have you worked and/or attended school (full-time or part-time) during the last 5 years (last 3 years if applying as the spouse of a U.S. citizen, or under VAWA)?',
  fields: [],
  repeating: {
    answerKey: 'schoolsAndEmployment',
    entryNoun: 'entry',
    summaryColumnLabel: 'Employer or School',
    summaryFieldNames: ['employerOrSchoolName', 'employerOrSchoolCity', 'employerOrSchoolState'],
    minEntries: 1,
    fields: [
