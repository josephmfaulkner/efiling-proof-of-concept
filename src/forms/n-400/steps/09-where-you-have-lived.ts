...
/** Real page is a repeating "Add an address" list — see i-130/08-your-address-history.ts for the same pattern. */
export const whereYouHaveLivedStep: StepSchema = {
  id: 'where-you-have-lived',
  section: 'About You',
  title: 'Where You Have Lived',
  description: 'List every location where you have lived during the last 5 years (last 3 years if applying as the spouse of a U.S. citizen, or under VAWA).',
  fields: [],
  repeating: {
    answerKey: 'addressHistory',
    entryNoun: 'address',
    summaryColumnLabel: 'Address',
    summaryFieldNames: ['livedAddressLine1', 'livedCity', 'livedState'],
    minEntries: 1,
    fields: [
