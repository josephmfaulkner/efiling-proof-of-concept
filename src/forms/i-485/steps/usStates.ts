...
export const US_STATE_OPTIONS: SelectOption[] = [
  ['AA', 'Armed Forces Americas'], ['AE', 'Armed Forces Europe'], ['AK', 'Alaska'], ['AL', 'Alabama'],
  ['AP', 'Armed Forces Pacific'], ['AR', 'Arkansas'], ['AS', 'American Samoa'], ['AZ', 'Arizona'],
  ...
  ['OR', 'Oregon'], ['PA', 'Pennsylvania'], ['PR', 'Puerto Rico'], ['PW', 'Palau'], ['RI', 'Rhode Island'],
